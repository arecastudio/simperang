...
Toast.makeText(Main.primaryStage, "", 3500, 500, 500);
 */
...
public final class Toast
{
    public static void makeText(Stage ownerStage, String toastMsg, int toastDelay, int fadeInDelay, int fadeOutDelay,Color color)
    {
        ...
        //toastStage.initStyle(StageStyle.UTILITY);
        ...
        root.setStyle("-fx-background-radius: 5; -fx-background-color: rgba(0, 0, 0, 0.2); -fx-padding: 25px;");
        root.setOpacity(0);
